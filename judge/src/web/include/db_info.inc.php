...
static 	$DB_PASS="byOogKRzvVeioSYw";  //数据库密码

static 	$OJ_NAME="C3CODING";  //左上角显示的系统名称
static 	$OJ_HOME="./";    //主页目录
...
if (isset($_SESSION[$OJ_NAME . '_' . 'OJ_LANG'])) {
	...
	$OJ_LANG=$_GET['lang'];
} else if (isset($_SERVER['HTTP_ACCEPT_LANGUAGE']) && strstr($_SERVER['HTTP_ACCEPT_LANGUAGE'], "ko-KR")) {
	$OJ_LANG="ko";
}
